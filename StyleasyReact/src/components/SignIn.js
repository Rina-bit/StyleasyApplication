        ...
        .then((data) => {
          ...
          if (data.data.success) {
            ...
            if (data.data.data.role === "CUSTOMER") {
              localStorage.setItem("CustomerId", data.data.data.userId);
              localStorage.setItem("CustomerName", data.data.data.userName);
              this.props.history.push("/CustomerDashboard");
            } else if (data.data.data.role === "ADMIN") {
              localStorage.setItem("AdminId", data.data.data.userId);
              localStorage.setItem("AdminName", data.data.data.userName);
